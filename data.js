...
const MENU_STRUCTURE = [
  { id: "gaap_tills", label: "GAAP - Tills / SCREENS / MOD PC", icon: "💻", subCategories: [
  ...
  { id: "internet", label: "Exmile - Internet", icon: "🌐", subCategories: [
  ...
  { id: "kiosks", label: "ODM - Kiosks", icon: "📺", subCategories: [
  ...
  { id: "cash", label: "Deposita - ABM", icon: "💵", subCategories: [
  ...
  { id: "g4s", label: "G4S - CIT", icon: "💵", subCategories: [
  ...
  { id: "headsets", label: "Headsets / Timers", icon: "🎧", subCategories: [
  ...
  { id: "music", label: "Gresham - Music", icon: "🎵", subCategories: [
  ...
  { id: "cards", label: "Card Machines", icon: "💳", subCategories: [
  ...
  { id: "cctv", label: "360 Degrees - CCTV", icon: "📹", subCategories: [
  ...
  { id: "printer", label: "Office Printer", icon: "🖨️", subCategories: [
  ...
  { id: "telephone", label: "Telephone", icon: "📞", subCategories: [
  ...
  { id: "office", label: "Emails", icon: "📧", subCategories: [
  ...
  { id: "tablets", label: "Tablets", icon: "📱", subCategories: [
  ...
  { id: "locks", label: "Door Locks", icon: "🔐", subCategories: [
...
const DEFAULT_CONTACTS = {
  "gaap_tills": { type: "call", contacts: [{ name: "Gaap Helpdesk", role: "Log on Retail Office 'New Case'. No calls.", phone: "" }, { name: "Abduragmaan (Gaap)", role: "POS / Cabling WhatsApp Escalation", phone: "0738600229" }] },
  ...
  "headsets": { type: "call", contacts: [{ name: "Gaap Workshop", role: "Log call, courier item.", phone: "" }, { name: "Andre (Gaap)", role: "Speaker Box / Timers Escalation", phone: "0715766421" }] },
